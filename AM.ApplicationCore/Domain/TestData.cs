...
public static class TestData
{
    ...
    public static List<Staff> staff = new()
    {
        new Staff
        {
            ...
            FirstName = "captain",
            LastName = "captain",
            EmailAddress = "captain.captain@example.com",
        ...
        new Staff
        {
            ...
            FirstName = "hostess1",
            LastName = "hostess1",
            EmailAddress = "hostess1.hostess1@example.com",
        ...
        new Staff
        {
            ...
            FirstName = "hostess2",
            LastName = "hostess2",
            EmailAddress = "hostess2.hostess2@example.com",
    ...
    public static List<Traveller> travellers = new()
    {
        new Traveller
        {
            ...
            LastName = "Traveller1",
            EmailAddress = "traveller1@example.com",
        ...
        new Traveller
        {
            ...
            LastName = "Traveller2",
            EmailAddress = "traveller2@example.com",
        ...
        new Traveller
        {
            ...
            LastName = "Traveller3",
            EmailAddress = "traveller3@example.com",
        ...
        new Traveller
        {
            ...
            LastName = "Traveller4",
            EmailAddress = "traveller4@example.com",
        ...
        new Traveller
        {
            ...
            LastName = "Traveller5",
            EmailAddress = "traveller5@example.com",
